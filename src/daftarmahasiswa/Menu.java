...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        //Dummy data
        listMhs.add(new Mahasiswa("2001680", "Ridha", "A"));
        listMhs.add(new Mahasiswa("2102167", "Yasmin", "A"));
        listMhs.add(new Mahasiswa("2100200", "Najwa", "A"));
    ...
    public void insertData() 
    {
        ...
        // Disini menggunakan isBlank karena lebih lengkap pengecekan di kolom inputnya.
        // Jika NIM dan Nama tidak dimasukan, maka akan muncul pop up failed to input data.
        if (nim.isBlank())
        {
            System.out.println("Insert Failed!");
            JOptionPane.showMessageDialog(null, "Failed to input data!");
        }
        ...
        else
        {
            ...
            JOptionPane.showMessageDialog(null, "Entered data successfully!");
        }
    }
